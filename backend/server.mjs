...
const FACEBOOK_APP_ID = '601790438830314';
const FACEBOOK_APP_SECRET = '92c0f1566092c1dd5cb0efd076a409c4';
  ...
  new FacebookStrategy(
    {
      ...
      // Your callback URL
      callbackURL: 'https://improved-adventure-wjjpvg7q75rcgpwp-5050.app.github.dev/facebook/callback', 
...
app.get('/facebook/callback', passport.authenticate('facebook', {
  ...
  successRedirect: 'https://improved-adventure-wjjpvg7q75rcgpwp-3000.app.github.dev/home', 
  // Redirect to login page on authentication failure.
  failureRedirect: 'https://improved-adventure-wjjpvg7q75rcgpwp-3000.app.github.dev/', 
}));
